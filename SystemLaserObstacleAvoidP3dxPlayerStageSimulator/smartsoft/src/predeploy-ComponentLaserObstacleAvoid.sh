#!/bin/bash
#
# This script is run prior to deployment of component ComponentLaserObstacleAvoid
...
#source $REFERENCED_PROJECT_ComponentLaserObstacleAvoid/smartsoft/src/predeploy.sh
