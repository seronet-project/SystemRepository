#!/bin/bash
#
# This script is run prior to deployment of component ComponentPlayerStageSimulator
...
#source $REFERENCED_PROJECT_ComponentPlayerStageSimulator/smartsoft/src/predeploy.sh
