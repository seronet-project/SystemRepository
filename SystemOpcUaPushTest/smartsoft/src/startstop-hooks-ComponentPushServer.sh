#!/bin/bash
#
# Start-Stop-Hooks for component ComponentPushServer
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentPushServer.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentPushServer.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentPushServer.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentPushServer.sh post-stop
