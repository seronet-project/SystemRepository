#!/bin/bash
#
# Start-Stop-Hooks for component ComponentPlayerStageSimulator
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentPlayerStageSimulator.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentPlayerStageSimulator.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentPlayerStageSimulator.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentPlayerStageSimulator.sh post-stop
