...
# Component instance ComponentPlayerStageSimulator
echo
echo "############################################"
echo "## Starting component instance ComponentPlayerStageSimulator"
cd $SCRIPT_DIR
echo "executing startstop-hooks-ComponentPlayerStageSimulator.sh (errors might be ignored)"
bash startstop-hooks-ComponentPlayerStageSimulator.sh pre-start
cd $SCRIPT_DIR/ComponentPlayerStageSimulator_data
rm -f "../ComponentPlayerStageSimulator.log"
xterm -l -lf "../ComponentPlayerStageSimulator.log" -title "ComponentPlayerStageSimulator@PC1 Component" -hold -e "export LD_LIBRARY_PATH=$SCRIPT_DIR:\$LD_LIBRARY_PATH; $SCRIPT_DIR/ComponentPlayerStageSimulator -filename=$SCRIPT_DIR/ComponentPlayerStageSimulator.ini; echo; echo; echo 'ComponentPlayerStageSimulator exited.'; echo; /bin/bash --login" &
echo $! >> $PID_XTERM
echo ComponentPlayerStageSimulator >> $PID_COMPONENT_NAMES
cd $SCRIPT_DIR
bash startstop-hooks-ComponentPlayerStageSimulator.sh post-start
echo -e "\n\n\n"
...
xterm -l -lf "../SmartCdlServer.log" -title "SmartCdlServer@PC1 Component" -hold -e "export LD_LIBRARY_PATH=$SCRIPT_DIR:\$LD_LIBRARY_PATH; $SCRIPT_DIR/SmartCdlServer -filename=$SCRIPT_DIR/SmartCdlServer.ini; echo; echo; echo 'SmartCdlServer exited.'; echo; /bin/bash --login" &
echo $! >> $PID_XTERM
...
xterm -l -lf "../SmartMapperGridMap.log" -title "SmartMapperGridMap@PC1 Component" -hold -e "export LD_LIBRARY_PATH=$SCRIPT_DIR:\$LD_LIBRARY_PATH; $SCRIPT_DIR/SmartMapperGridMap -filename=$SCRIPT_DIR/SmartMapperGridMap.ini; echo; echo; echo 'SmartMapperGridMap exited.'; echo; /bin/bash --login" &
echo $! >> $PID_XTERM
...
xterm -l -lf "../SmartRobotConsole.log" -title "SmartRobotConsole@PC1 Component" -hold -e "export LD_LIBRARY_PATH=$SCRIPT_DIR:\$LD_LIBRARY_PATH; $SCRIPT_DIR/SmartRobotConsole -filename=$SCRIPT_DIR/SmartRobotConsole.ini; echo; echo; echo 'SmartRobotConsole exited.'; echo; /bin/bash --login" &
echo $! >> $PID_XTERM
...
stop)
cd $SCRIPT_DIR
bash startstop-hooks-ComponentPlayerStageSimulator.sh pre-stop
...
bash startstop-hooks-ComponentPlayerStageSimulator.sh post-stop
