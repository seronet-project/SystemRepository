#!/bin/bash
#
# Start-Stop-Hooks for component SmartLaserLMS200Server
#
...
pre-start)
	...
	bash startstop-hooks-component-SmartLaserLMS200Server.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartLaserLMS200Server.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartLaserLMS200Server.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartLaserLMS200Server.sh post-stop
