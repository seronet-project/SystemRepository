#!/bin/bash
#
# Start-Stop-Hooks for component SmartPioneerBaseServer
#
...
pre-start)
	...
	bash startstop-hooks-component-SmartPioneerBaseServer.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartPioneerBaseServer.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartPioneerBaseServer.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartPioneerBaseServer.sh post-stop
