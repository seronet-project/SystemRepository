...
start)
	...
	echo "Starting student@c26-11-robota"
	xterm -fg red -title "SSH: student@c26-11-robota" -e 'echo;echo "Starting remote SSH session at student@c26-11-robota ..."; echo;echo;ssh -X student@c26-11-robota "cd /tmp/SystemP3dxNavigationRealWorld.deployment; pwd; bash --login -i -e start-C26_11_RobotA.sh start"' &
	echo $! >> $PID_FILE
