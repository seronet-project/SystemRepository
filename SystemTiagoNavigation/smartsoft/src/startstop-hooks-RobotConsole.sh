#!/bin/bash
#
# Start-Stop-Hooks for component RobotConsole
#
...
pre-start)
	...
	bash startstop-hooks-component-SmartRobotConsole.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartRobotConsole.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartRobotConsole.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartRobotConsole.sh post-stop
