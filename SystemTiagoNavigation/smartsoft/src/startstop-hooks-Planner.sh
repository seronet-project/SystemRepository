#!/bin/bash
#
# Start-Stop-Hooks for component Planner
#
...
pre-start)
	...
	bash startstop-hooks-component-SmartPlannerBreadthFirstSearch.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartPlannerBreadthFirstSearch.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartPlannerBreadthFirstSearch.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SmartPlannerBreadthFirstSearch.sh post-stop
