#!/bin/bash
#
# Start-Stop-Hooks for component ComponentTTS
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentTTS.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentTTS.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentTTS.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentTTS.sh post-stop
