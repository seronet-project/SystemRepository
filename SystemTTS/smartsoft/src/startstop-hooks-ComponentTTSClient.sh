#!/bin/bash
#
# Start-Stop-Hooks for component ComponentTTSClient
#
...
pre-start)
	...
	bash startstop-hooks-component-ComponentTTSClient.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentTTSClient.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentTTSClient.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-ComponentTTSClient.sh post-stop
