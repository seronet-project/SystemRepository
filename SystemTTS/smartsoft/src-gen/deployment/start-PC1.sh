...
# Component instance ComponentTTS
echo
echo "############################################"
echo "## Starting component instance ComponentTTS"
cd $SCRIPT_DIR
echo "executing startstop-hooks-ComponentTTS.sh (errors might be ignored)"
bash startstop-hooks-ComponentTTS.sh pre-start
cd $SCRIPT_DIR/ComponentTTS_data
rm -f "../ComponentTTS.log"
xterm -l -lf "../ComponentTTS.log" -title "ComponentTTS@PC1 Component" -hold -e "export LD_LIBRARY_PATH=$SCRIPT_DIR:\$LD_LIBRARY_PATH; $SCRIPT_DIR/ComponentTTS -filename=$SCRIPT_DIR/ComponentTTS.ini; echo; echo; echo 'ComponentTTS exited.'; echo; /bin/bash --login" &
echo $! >> $PID_XTERM
echo ComponentTTS >> $PID_COMPONENT_NAMES
cd $SCRIPT_DIR
bash startstop-hooks-ComponentTTS.sh post-start
echo -e "\n\n\n"

# Component instance ComponentTTSClient
echo
echo "############################################"
echo "## Starting component instance ComponentTTSClient"
cd $SCRIPT_DIR
echo "executing startstop-hooks-ComponentTTSClient.sh (errors might be ignored)"
bash startstop-hooks-ComponentTTSClient.sh pre-start
cd $SCRIPT_DIR/ComponentTTSClient_data
rm -f "../ComponentTTSClient.log"
xterm -l -lf "../ComponentTTSClient.log" -title "ComponentTTSClient@PC1 Component" -hold -e "export LD_LIBRARY_PATH=$SCRIPT_DIR:\$LD_LIBRARY_PATH; $SCRIPT_DIR/ComponentTTSClient -filename=$SCRIPT_DIR/ComponentTTSClient.ini; echo; echo; echo 'ComponentTTSClient exited.'; echo; /bin/bash --login" &
echo $! >> $PID_XTERM
echo ComponentTTSClient >> $PID_COMPONENT_NAMES
cd $SCRIPT_DIR
bash startstop-hooks-ComponentTTSClient.sh post-start
echo -e "\n\n\n"
...
stop)
cd $SCRIPT_DIR
bash startstop-hooks-ComponentTTS.sh pre-stop
bash startstop-hooks-ComponentTTSClient.sh pre-stop
...
bash startstop-hooks-ComponentTTS.sh post-stop
bash startstop-hooks-ComponentTTSClient.sh post-stop
